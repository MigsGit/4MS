...
sudo mysqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_pats_ppd_cn > db_pats_ppd_cn.sql
...
sudo mysqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_pats_ppd > db_pats_ppd.sql
sudo mysqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_pats_ppd_cn_f3 > db_pats_ppd_cn_f3.sql
sudo mysqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_pmcsfes_v2 > db_pmcsfes_v2.sql
sudo mysqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_walk_in > db_walk_in.sql
sudo mysqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_rfq_v4 > db_rfq_v4.sql
sudo mysqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e cn_ppts_v2_1 > cn_ppts_v2_1.sql
sudo mysqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_qad_4m > db_qad_4m.sql
sudo sqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_cn_ppts_v2_1 > db_cn_ppts_v2_1.sql
sudo sqldump -h$DB_ADDRESS -u$DB_USER -p$DB_PASSWORD -e db_pats_v2 > db_pats_v2.sql
...
smbclient $ADDRESS -U $DOMAIN/$USER%$PASSWORD -c "cd $PATH_BACKUP/$FILE_NAME; put cn_ppts_v2_1.sql"
smbclient $ADDRESS -U $DOMAIN/$USER%$PASSWORD -c "cd $PATH_BACKUP/$FILE_NAME; put db_ts_ppts.sql"
smbclient $ADDRESS -U $DOMAIN/$USER%$PASSWORD -c "cd $PATH_BACKUP/$FILE_NAME; put db_qad_4m.sql"
smbclient $ADDRESS -U $DOMAIN/$USER%$PASSWORD -c "cd $PATH_BACKUP/$FILE_NAME; put db_pats_v2.sql"
smbclient $ADDRESS -U $DOMAIN/$USER%$PASSWORD -c "cd $PATH_BACKUP/$FILE_NAME; put db_cn_ppts_v2_1.sql"
