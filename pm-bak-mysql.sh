...
PATH_BACKUP='/rapidx/PM'
AM_PATH_BACKUP='/rapidx/AM'
...
smbclient $ADDRESS -U $DOMAIN/$USER%$PASSWORD -c "cd $PATH_BACKUP/$FILE_NAME; put db_pats_ppd_cn.sql"
...
smbclient $ADDRESS -U $DOMAIN/$USER%$PASSWORD -c "cd $AM_PATH_BACKUP/$FILE_NAME; rm db_aidrc_2.sql"
